...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeRequests(a -> a
                        ...
                        .antMatchers(projectPrefix + projectMappingProperties.getDelete()).access("@projectAuthChecker.projectAuthCheck(request, authentication, T(com.nhn.minidooray.gateway.domain.enums.ProjectAuthorityType.PermissionType).MODIFY)")
